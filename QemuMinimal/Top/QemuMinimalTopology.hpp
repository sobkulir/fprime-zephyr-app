// ======================================================================
// \title  QemuMinimalTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef QemuMinimal_QemuMinimalTOPOLOGY_HPP
#define QemuMinimal_QemuMinimalTOPOLOGY_HPP
// Included for access to QemuMinimal::TopologyState and QemuMinimal::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <QemuMinimal/Top/QemuMinimalTopologyDefs.hpp>

// Remove unnecessary QemuMinimal:: qualifications
 ...
 * QemuMinimal::TopologyState see: QemuMinimalTopologyDefs.hpp.
 *
