// ======================================================================
// \title  LedMinimalTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <LedMinimal/Top/LedMinimalTopologyAc.hpp>
#include <LedMinimal/Top/LedMinimalPacketsAc.hpp>
...
void configureTopology() {
    ...
    // tlmSend.setPacketList(LedMinimalPacketsPkts, LedMinimalPacketsIgnore, 1);
}

// Public functions for use in main program are namespaced with deployment name LedMinimal
